# SharePoint PnP PowerShell Provisioning Script for 'CRM'
...
Ensure-SharePointList -Title "CRM"

Add-SharePointField -ListTitle "CRM" -DisplayName "Contact Person" -InternalName "ContactPerson" -Type "Text"
Add-SharePointField -ListTitle "CRM" -DisplayName "Email" -InternalName "Email" -Type "Text"
Add-SharePointField -ListTitle "CRM" -DisplayName "Phone" -InternalName "Phone" -Type "Text"
Add-SharePointField -ListTitle "CRM" -DisplayName "Lead Status" -InternalName "Status" -Type "Choice" -Choices @("Lead", "Contacted", "Proposal", "Contracted", "Lost")
Add-SharePointField -ListTitle "CRM" -DisplayName "Estimated Value" -InternalName "EstimatedValue" -Type "Currency"
Add-SharePointField -ListTitle "CRM" -DisplayName "Assigned To" -InternalName "AssignedTo" -Type "User"

Write-Host "Provisioning of list 'CRM' completed successfully!" -ForegroundColor Green