# SharePoint PnP PowerShell Provisioning Script for 'Approvals'
...
Ensure-SharePointList -Title "Approvals"

Add-SharePointField -ListTitle "Approvals" -DisplayName "Related Contract" -InternalName "RelatedContract" -Type "Lookup" -LookupList "Contracts" -LookupField "Title"
Add-SharePointField -ListTitle "Approvals" -DisplayName "Approver" -InternalName "Approver" -Type "User"
Add-SharePointField -ListTitle "Approvals" -DisplayName "Approval Status" -InternalName "Status" -Type "Choice" -Choices @("Pending", "Approved", "Rejected")
Add-SharePointField -ListTitle "Approvals" -DisplayName "Submission Date" -InternalName "SubmissionDate" -Type "DateTime"
Add-SharePointField -ListTitle "Approvals" -DisplayName "Comments" -InternalName "Comments" -Type "Note"

Write-Host "Provisioning of list 'Approvals' completed successfully!" -ForegroundColor Green