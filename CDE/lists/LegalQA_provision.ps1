# SharePoint PnP PowerShell Provisioning Script for 'LegalQA'
...
Ensure-SharePointList -Title "LegalQA"

Add-SharePointField -ListTitle "LegalQA" -DisplayName "Contract Reference" -InternalName "ContractRef" -Type "Lookup" -LookupList "Contracts" -LookupField "Title"
Add-SharePointField -ListTitle "LegalQA" -DisplayName "Assigned Legal Expert" -InternalName "AssignedLegalExpert" -Type "User"
Add-SharePointField -ListTitle "LegalQA" -DisplayName "Severity" -InternalName "Severity" -Type "Choice" -Choices @("Low", "Medium", "High", "Critical")
Add-SharePointField -ListTitle "LegalQA" -DisplayName "Resolution Date" -InternalName "ResolutionDate" -Type "DateTime"
Add-SharePointField -ListTitle "LegalQA" -DisplayName "Audit Status" -InternalName "AuditStatus" -Type "Choice" -Choices @("Open", "In Progress", "Resolved")

Write-Host "Provisioning of list 'LegalQA' completed successfully!" -ForegroundColor Green