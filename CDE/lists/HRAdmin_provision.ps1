# SharePoint PnP PowerShell Provisioning Script for 'HRAdmin'
...
Ensure-SharePointList -Title "HRAdmin"

Add-SharePointField -ListTitle "HRAdmin" -DisplayName "Employee User" -InternalName "EmployeeUser" -Type "User"
Add-SharePointField -ListTitle "HRAdmin" -DisplayName "Department" -InternalName "Department" -Type "Choice" -Choices @("Engineering", "Sales", "HR", "Finance", "Legal")
Add-SharePointField -ListTitle "HRAdmin" -DisplayName "Job Title" -InternalName "JobTitle" -Type "Text"
Add-SharePointField -ListTitle "HRAdmin" -DisplayName "Hire Date" -InternalName "HireDate" -Type "DateTime"
Add-SharePointField -ListTitle "HRAdmin" -DisplayName "Skills" -InternalName "Skills" -Type "MultiChoice" -Choices @("Python", "SharePoint", "PowerAutomate", "Legal", "Finance", "React", "AWS")
Add-SharePointField -ListTitle "HRAdmin" -DisplayName "Salary" -InternalName "Salary" -Type "Currency"

Write-Host "Provisioning of list 'HRAdmin' completed successfully!" -ForegroundColor Green