...
- [ ] **[T-02: Gia Cố Vận Hành Git, Khóa An Toàn Flock & Dọn Dẹp Nhánh Rác Remote](tickets/02_git_safety_and_remote_branch_lifecycle.md)** `[Task (AFK)]` *(UNBLOCKED - Ưu tiên 2)*
- [ ] **[T-03: Cầu Nối Adapter Real LLM, Token Budget Ceiling & Circuit Breaker](tickets/03_real_llm_adapter_and_token_governance.md)** `[Research / Task [AFK]]` *(UNBLOCKED - Ưu tiên 3)*
- [ ] **[T-04: Xây Dựng Bộ Đề Thi & Scorer Chuyên Biệt Cho Coordination V2 & Orchestration](tickets/04_specialized_domain_datasets_and_scorers.md)** `[Research [AFK] / Prototype [HITL]]` *(UNBLOCKED - Ưu tiên 4)*
