...
- Nạp các kỹ năng liên quan: [api-circuit-breaker](file:///d:/GitHubProjects/ccba-agent-platform/.agents/skills/api-circuit-breaker/SKILL.md), [append-only-logger](file:///d:/GitHubProjects/ccba-agent-platform/.agents/skills/append-only-logger/SKILL.md), [eval-gate](file:///d:/GitHubProjects/ccba-agent-platform/.agents/skills/eval-gate/SKILL.md), [code-review](file:///d:/GitHubProjects/ccba-agent-platform/.agents/skills/code-review/SKILL.md).
...
2. **[Tách biệt Log Output khỏi Terminal Stream](file:///d:/GitHubProjects/ccba-agent-platform/scripts/run_isolated_tests.py)**: Toàn bộ log của bài test/eval ngầm được ghi vào file `.md/scratch/eval_runs/<run_id>.log` để giữ terminal sạch sẽ và tránh đứt kết nối stream.

---

## 🚀 4. Danh sách các Ticket Biên Giới (Frontier Tickets)

* **[Ticket 1: Thiết kế & Triển khai `scripts/run_safe_eval_wrapper.py`](file:///d:/GitHubProjects/ccba-agent-platform/scripts/run_safe_eval_wrapper.py)** `[AFK/Task]`
...
* **[Ticket 2: Chuẩn hóa Định dạng Báo cáo Chẩn đoán Cấu trúc (`diagnostics.json`)](file:///d:/GitHubProjects/ccba-agent-platform/.md/scratch/eval_runs/diagnostics.json)** `[AFK/Task]`
...
* **[Ticket 3: Tích hợp Self-Healing Feedback Protocol cho Agent](file:///d:/GitHubProjects/ccba-agent-platform/.agents/skills/eval-gate/SKILL.md)** `[HITL/Research]`
