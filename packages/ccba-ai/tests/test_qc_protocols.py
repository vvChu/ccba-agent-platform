...
from ccba_ai import QCAuditEngine, QCReporterEngine, AuditReport, AuditFinding
...
def test_mock_orchestration_run():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        level_images = {
            "L1": [Path("dummy_arch.png"), Path("dummy_kc.png"), Path("dummy_mep.png"), Path("dummy_pccc.png")]
        }
