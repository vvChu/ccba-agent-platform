"""Radial Layout Engine (Hub-and-Spoke Star Graph)."""
...
def apply_radial_layout(
    elements: list[dict[str, Any]],
    theme: DiagramTheme = DEFAULT_THEME,
) -> bool:
    """Apply Radial Layout to Excalidraw elements in-place.
    ...
    hub_id = max(degrees, key=degrees.get) if degrees else list(g.nodes)[0]
