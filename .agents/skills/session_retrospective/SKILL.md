...
### 2. Tiến hóa Kỹ năng Trực tiếp (Direct Skill Evolution Loop)
- **Nguyên tắc "Học đi đôi với Hành":** Không dừng lại ở việc ghi nhận thụ động vào `session_learnings.md`. Nếu bài học chỉ ra một quy trình trong `SKILL.md` (như `improve-codebase-architecture`, `code-review`, `tvpl-vip-crawler`...) còn thiếu rào chắn hoặc gây sai lệch:
...
- **Tiêu chí hoàn thành:** Các `SKILL.md` liên quan trực tiếp đến bài học của phiên được cập nhật hoàn chỉnh và nhất quán.

### 3. Cập nhật Knowledge Base Hệ thống
...
3. **Kiểm tra Test Suite cục bộ:**
   ...
   ```
- **Tiêu chí hoàn thành:** Cả 3 lệnh kiểm định đều chạy thành công (Exit code 0), không còn lỗi đứt gãy liên kết hay lệch tài liệu kiến trúc.
