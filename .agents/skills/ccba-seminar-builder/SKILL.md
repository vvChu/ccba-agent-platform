...
* **Tham chiếu liên kết:** Mọi tài liệu mở rộng đều được dẫn xuất qua liên kết Markdown chuẩn mực: [`references/interactive_teaching.md`](references/interactive_teaching.md).
