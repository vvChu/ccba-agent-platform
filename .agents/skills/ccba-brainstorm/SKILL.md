...
1. **Chuyển đổi tài liệu:** Chuyển đổi theo quy trình `/ccba-convert-markdown` — tham khảo skill [markdown-document-processing](../ccba-markdown-document-processing/SKILL.md) cho quy tắc routing theo `project.mode`.
