...
3. Ask user about HTML preview → `ask_question` tool
4. If yes, generate an interactive HTML preview gallery

## Detailed References

- `logo-style-guide.md` - Detailed style descriptions
- `logo-color-psychology.md` - Color meanings and combinations
