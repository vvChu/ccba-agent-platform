...
**MRs là một request surface: no.** _(Chuyển thành `yes` nếu dự án của bạn chấp nhận MR từ cộng tác viên ngoài gửi đến như một yêu cầu tính năng cần phân loại; công cụ `/triage` sẽ đọc cờ này).*
