...
**Xem PR như yêu cầu tính năng: no.** _(Chuyển thành `yes` nếu dự án của bạn chấp nhận PR từ cộng tác viên ngoài gửi đến như một yêu cầu tính năng cần phân loại; công cụ `/triage` sẽ đọc cờ này).*
