# ccba-wizard — Reference Guide

> **Mục đích & Ngữ cảnh sử dụng:** Kịch bản hướng dẫn tương tác từng bước khi khởi tạo dự án Spoke mới
> **Mô tả gốc:** Generate an interactive bash wizard that walks a human through a manual procedure — third-party setup, a one-off migration, an A→B state transition — opening URLs, capturing values, confirming each step, and writing .env files and GitHub Actions secrets.
