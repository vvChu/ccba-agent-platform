# ccba-pccc-thamdinh-cqxd — Reference Guide

> **Mục đích & Ngữ cảnh sử dụng:** Danh mục SOP thẩm tra quy chuẩn xây dựng và an toàn cháy với Sở Xây dựng
> **Mô tả gốc:** Quy trình Thẩm định/Thẩm tra PCCC phần Kiến trúc & Kiểm soát khói nộp Cơ quan chuyên môn về xây dựng (theo Luật 55/2024 & NĐ 105/2025)
