# ccba-pccc-thamdinh-congan — Reference Guide

> **Mục đích & Ngữ cảnh sử dụng:** Danh mục SOP thẩm duyệt thiết kế PCCC với Cơ quan Công an PCCC
> **Mô tả gốc:** Quy trình Thẩm định thiết kế PCCC phần Hệ thống Cơ điện (MEP) nộp Cơ quan Công an (PC07)
