...
*   **Tệp tin sửa đổi:** [_mutex.py](packages/ccba-harness/src/ccba_harness/_mutex.py)
...
*   **Tệp tin sửa đổi:** [test_plan_manager.py](packages/ccba-ai/tests/test_plan_manager.py)
...
*   **Tệp tin sửa đổi:** [.github/workflows/ci.yml](.github/workflows/ci.yml)
...
*   **Tệp tin sửa đổi:** [visual_extractor.py](.agents/skills/youtube-learn/scripts/visual_extractor.py)
