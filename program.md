...
> Thí nghiệm Red-Teaming & Bẫy Pháp Lý (Adversarial Hard Floor Stress-Testing) cho kỹ năng Tra cứu & Pháp điển Pháp luật (ccba-legal-intel).
...
- **Target Score**: 95.0%
- **Max Iterations**: 5
- **Dataset File**: .agents/skills/eval-gate/test_cases/eval_legal_intel_redteam.json
