...
│   ├── skills/                        ←   Reusable AI skills (<!-- SKILL_COUNT_START -->71<!-- SKILL_COUNT_END --> skills)
...
Hệ thống kỹ năng (<!-- SKILL_COUNT_START -->71<!-- SKILL_COUNT_END --> skills) được phân làm hai loại chính dựa trên cơ chế kích hoạt và tương tác:
