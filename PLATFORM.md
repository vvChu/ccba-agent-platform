...
| `ccba-legal-intel` | Legal intelligence services, legislative consolidator, OKF v2.4 GoldStandard, Gate 4, Federated RAG, Multi-Pass Legal OCR Text Normalizers, Multi-Scope GoogleDriveIngestor & Decoupled drive_client | `pip install -e "packages/ccba-legal-intel"` |
