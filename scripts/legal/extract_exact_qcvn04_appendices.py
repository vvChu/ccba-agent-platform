...
def extract_appendices(bundle_dir: Path | None = None) -> None:
    ...
    if idx_a != -1:
        ...
        print(
            f" ✅ Extracted Phụ lục A: {len(text_a):,} characters, {len(text_a.splitlines())} lines"
        )
    ...
    if idx_b != -1:
        ...
        print(
            f" ✅ Extracted Phụ lục B: {len(text_b):,} characters, {len(text_b.splitlines())} lines"
        )
    ...
    if idx_c != -1:
        ...
        print(
            f" ✅ Extracted Phụ lục C: {len(text_c):,} characters, {len(text_c.splitlines())} lines"
        )
