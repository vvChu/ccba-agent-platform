...
| :--- | :--- | :---: |
| [ADR 0001](0001-standardize-skill-steps-format.md) | Standardize Skill Steps Format | ✅ ACCEPTED |
| [ADR 0002](0002-hierarchical-skill-validation.md) | Hierarchical Skill Validation | ✅ ACCEPTED |
| [ADR 0003](0003-object-oriented-plan-management.md) | Object Oriented Plan Management | ✅ ACCEPTED |
| [ADR 0004](0004-academic-writing-microstructure-auditing.md) | Academic Writing Microstructure Auditing | ✅ ACCEPTED |
| [ADR 0005](0005-academic-paper-formatting-and-citations.md) | Academic Paper Formatting And Citations | ✅ ACCEPTED |
| [ADR 0006](0006-skills-quality-alignment-for-academic-writing.md) | Skills Quality Alignment For Academic Writing | ✅ ACCEPTED |
| [ADR 0007](0007-multimodal-youtube-learning-and-transcription.md) | Multimodal Youtube Learning And Transcription | ✅ ACCEPTED |
| [ADR 0008](0008-spoke-classification-and-functional-ownership.md) | Spoke Classification And Functional Ownership | ✅ ACCEPTED |
| [ADR 0009](0009-hub-spoke-sync-and-partition-strategy.md) | Hub Spoke Sync And Partition Strategy | ✅ ACCEPTED |
| [ADR 0010](0010-skills-integration-and-rag-boundaries.md) | Phân Định Ranh Giới Tích Hợp Kỹ Năng Nghiên Cứu & Mẫu Thử | ✅ ACCEPTED |
| [ADR 0017](0017-dynamic-override-notebook-ids-via-environment-variables.md) | Dynamic Override Notebook Ids Via Environment Variables | ✅ ACCEPTED |
...
| [ADR 0025](0025-ai-gateway-client-configuration-standardization.md) | Ai Gateway Client Configuration Standardization | ✅ ACCEPTED |
| [ADR 0026](0026-isolated-test-runner-and-timeout-policy.md) | Isolated Test Runner And Timeout Policy | ✅ ACCEPTED |
| [ADR 0027](0027-deepen-notebooklm-service-module.md) | Deepen NotebookLMService Module & Separate Service Layer | ✅ ACCEPTED |
| [ADR 0028](0028-deepen-detached-execution-engine.md) | Deepen Detached Execution Engine | ✅ ACCEPTED |
| [ADR 0029](0029-ai-gateway-client-integration-contract.md) | Ai Gateway Client Integration Contract | ✅ ACCEPTED |
| [ADR 0030](0030-progressive-disclosure-and-instruction-budget-optimization.md) | Progressive Disclosure And Instruction Budget Optimization | ✅ ACCEPTED |
...
| [ADR 0032](0032-monorepo-hierarchical-agents-md.md) | Monorepo Hierarchical Agents Md | ✅ ACCEPTED |
| [ADR 0033](0033-automation-first-quality-enforcement.md) | Automation First Quality Enforcement | ✅ ACCEPTED |
| [ADR 0034](0034-cross-agent-parity-bridge.md) | Cross Agent Parity Bridge | ✅ ACCEPTED |
| [ADR 0035](0035-polyglot-deep-modules-and-subagent-guardrails.md) | Polyglot Deep Modules And Subagent Guardrails | ✅ ACCEPTED |
