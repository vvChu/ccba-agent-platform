...
> **Mô tả ngắn**: Quản trị vòng đời Chrome CDP (Port 9222), Chrome DevTools MCP, Persistent Profile và công cụ /browser cho Antigravity & CCBA Platform.
...
| **Điểm Đánh Giá GPI (ADR-0057)** | `S=4.0 | K=3.0 | A=2.0 | P=1.0 (GPI: 18.50)` |
...
### Mục Đích Hoạt Động
Quản trị vòng đời Chrome CDP (Port 9222), Chrome DevTools MCP, Persistent Profile và công cụ /browser cho Antigravity & CCBA Platform.
...
python scripts/validate_skills.py --file .agents/skills/ccba-chrome-debug/SKILL.md --enforce-gpi
```
