...
> **Mô tả ngắn**: Hướng dẫn, cấu trúc, và kiểm duyệt vi mô các bài báo nghiên cứu khoa học theo chuẩn quốc tế (IMRAD, CARS model).
...
### Mục Đích Hoạt Động
Hướng dẫn, cấu trúc, và kiểm duyệt vi mô các bài báo nghiên cứu khoa học theo chuẩn quốc tế (IMRAD, CARS model).
...
- Khi cần thực thi nghiệp vụ liên quan trực tiếp đến vai trò: Hỗ trợ viết bài báo nghiên cứu khoa học chuẩn cấu trúc học thuật quốc tế.
- Trong chuỗi phát triển khi nhận tín hiệu bàn giao từ: **Kết quả nghiên cứu thực nghiệm**
...
Kỹ năng `ccba-academic-writing` giữ vị trí then chốt trong chuỗi giá trị tích hợp của nền tảng:

```text
[ Kết quả nghiên cứu thực nghiệm ]
          │
          ▼
    >>> [ ccba-academic-writing ] <<<  (Hỗ trợ viết bài báo nghiên cứu khoa học chuẩn cấu trúc học thuật quốc tế.)
          │
          ▼
[ Bài báo khoa học định dạng chuẩn ]
```

- **Đầu vào (Upstream)**: Nhận bối cảnh từ `Kết quả nghiên cứu thực nghiệm`.
- **Thực thi (In-flight)**: Áp dụng các quy tắc kỹ thuật và công cụ tự động hóa để sản sinh kết quả chuẩn mực.
- **Đầu ra & Bàn giao (Downstream)**: Chuyển giao thành phẩm sạch sẽ sang `Bài báo khoa học định dạng chuẩn`.
...
python scripts/validate_skills.py --file .agents/skills/ccba-academic-writing/SKILL.md --enforce-gpi
```
