...
Verifies that:
1. All 70 active skills are classified into docs/skills/portals.yaml with zero duplicates or orphans.
...
def test_all_active_skills_in_portals_yaml_exactly_match(
    ...
    assert len(active_skill_names) == 70, (
        f"Expected exactly 70 active skills, found {len(active_skill_names)}"
    )
