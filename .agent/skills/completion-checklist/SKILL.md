...
| File | Mô tả |
|------|--------|
| `data/checklist_master.yaml` | Danh mục hồ sơ master theo NĐ 06/2021 Phụ lục VIb |
| `templates/checklist_by_project.md` | Template checklist theo loại công trình |
| `templates/training_handout.md` | Template tài liệu tập huấn cho kỹ sư giám sát |

## How to Use

### 1. Tạo Checklist cho dự án cụ thể

1. Đọc `data/checklist_master.yaml` để nắm cấu trúc master
2. Hỏi user các thông tin dự án:
   ...
   - Chủ đầu tư
3. Đọc template `templates/checklist_by_project.md`
