...
description: Tạo file Excalidraw JSON (.excalidraw) cho Obsidian hoặc excalidraw.com. Áp dụng phương pháp "diagram as visual argument" — mỗi hình dạng PHẢN ÁNH ý nghĩa khái niệm của nó. Dùng khi user muốn trực quan hóa luồng, kiến trúc, khung chiến lược, hoặc bất kỳ mô hình tư duy nào.
applies_to:
  - "Diagram"
  - "Excalidraw"
  - "Visualization"
