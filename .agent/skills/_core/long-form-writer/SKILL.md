...
description: Generates comprehensive, long-form documentation (2000+ words) by actively managing the LLM context to bypass output token limits. Ideal for detailed regulations, whitepapers, or complex manuals.
applies_to:
  - "Phần mềm"
  - "Thẩm tra thiết kế"
  - "Thiết kế"
...
2. **Run the Script**:
    ...
    ```powershell
    python .agent/skills/long-form-writer/scripts/generate.py --prompt "YOUR_DETAILED_PROMPT" --output "absolute/path/to/output.docx" --cycles 3
    ```
