...
description: Core workflow cho BIGBIM. Hướng dẫn AI Agent thực hiện tự động hóa viết bảng thực thể (En) và phân loại không gian vật tư, vật liệu (PM) theo hệ thống Uniclass 200, tích hợp 3 chuẩn ISO (22274, 21511, 12006-2) và 2 nhánh lớn Building (ISO 19650 Room Naming) & Infrastructure (IFC Alignment + GIS).
applies_to:
  - "Quản lý thông tin"
  - "Thiết kế"
  - "Thẩm tra thiết kế"
...
*   **Skill Path**: `.agent/skills/_core/bigbim-classification/SKILL.md`
