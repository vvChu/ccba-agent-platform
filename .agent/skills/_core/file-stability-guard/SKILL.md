...
description: Pattern phát hiện file đã sync hoàn toàn trước khi xử lý. Thay thế time.sleep() bằng kiểm tra kích thước thực tế — dành cho pipelines xử lý file từ cloud sync (Google Drive, OneDrive, SharePoint).
applies_to:
  - "Phần mềm"
  - "Kiểm định"
bundle: "_core"
