---
name: bigbim-rase
description: Core workflow cho BIGBIM. Hướng dẫn AI Agent thực hiện phân tích RASE (Requirement, Applicability, Selection, Exception) tự động cho dự án BIM dựa trên sơ đồ dữ liệu IFC4X3 và bộ Quantity Take-Off (Qto_xxx).
applies_to:
  - "Thẩm tra thiết kế"
  - "Thiết kế"
  - "Quản lý thông tin"
...
*   **Skill Path**: `.agent/skills/_core/bigbim-rase/SKILL.md`
