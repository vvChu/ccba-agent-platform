---
name: bigbim-risk
description: Core workflow cho BIGBIM. Trang bị cho AI Agent tư duy quét và phát hiện các "Mâu thuẫn thông tin" (Information Conflict) phi hình học tại bước phối hợp thông tin V2 - Coordination, vượt ngoài giới hạn của Clash Detection truyền thống.
applies_to:
  - "Quản lý thông tin"
  - "Thẩm tra thiết kế"
bundle: "_core"
...
*   **Skill Path**: `.agent/skills/_core/bigbim-risk/SKILL.md`
