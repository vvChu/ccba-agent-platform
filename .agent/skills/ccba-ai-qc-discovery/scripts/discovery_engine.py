...
class IDOPDiscovery:
    ...
    async def extract_metadata_from_titleblock(
        ...
        img_bytes = titleblock_path.read_bytes()
...
def _get_vision_client():
    ...
    Reads AI_GATEWAY_URL and AI_GATEWAY_KEY from environment/.env.
    Falls back to the known Tailscale endpoint.
    """
    import os
...
def _safe_parse_json(text: str) -> dict:
    """Parse JSON from AI response, stripping any markdown wrappers."""
    import re
